...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      leads: {
        Row: {
          ...
          quien_contacta: Database['public']['Enums']['tipo_contacto_caso'] | null;
    ...
    Enums: {
      ...
      estado_campana: 'borrador' | 'programada' | 'enviando' | 'enviada' | 'cancelada';
      ...
      metodo_cobro: 'transferencia' | 'tarjeta' | 'efectivo' | 'domiciliacion' | 'otro';
      ...
      tipo_actividad: 'llamada' | 'whatsapp' | 'email' | 'nota' | 'cambio_estado' | 'reapertura';
      tipo_cita:
        | 'primera_llamada'
        | 'primera_cita'
        | 'valoracion'
      ...
      tipo_documento_clinico: 'consentimiento' | 'informe' | 'derivacion' | 'otro';
