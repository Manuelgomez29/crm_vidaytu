  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="flex flex-col gap-5 rounded-xl bg-surface p-5 ring-1 ring-line"
      >
        {/*
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="flex flex-col gap-1 text-sm font-medium text-ink">
            ...
            <span className="text-xs font-normal text-ink2">
              ...
              plantilla de arriba. El asunto es solo «Confirmacion de tu cita»: se lee en la bandeja
              de entrada sin abrir nada.
            </span>
          </label>
          ...
          <label className="flex flex-col gap-1 text-sm font-medium text-ink">
            ...
            <span className="text-xs font-normal text-ink2">
              Al comercial disponible del centro con menos carga, nunca a alguien ausente. Apagado
              por defecto: mientras el equipo se rueda, la autoasignacion con un clic funciona
              mejor, porque el comercial ve el caso antes de cogerlo.
            </span>
          </label>
        </div>
        ...
        <label className="flex flex-col gap-1 text-sm font-medium text-ink">
          ...
          />
          <span className="text-xs font-normal text-warn">
            Debe contener el marcador de baja. Es el enlace para darse de baja en un clic, y sin el
            la plataforma rechaza el cambio.
          </span>
        </label>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <label className="flex flex-col gap-1 text-sm font-medium text-ink">
            ...
            />
            <span className="text-xs font-normal text-ink2">
              Los servicios sanitarios suelen ir exentos. Confirmalo con la gestoria antes de emitir
              en serie.
            </span>
          </label>
        </div>
        ...
        <hr className="border-line" />
        <h2 className="text-sm font-semibold uppercase tracking-wide text-ink2">Asistente de IA</h2>
        ...
        <label className="flex flex-col gap-1 text-sm font-medium text-ink">
          ...
          <span className="text-xs font-normal text-warn">
            ...
            El asistente responde unicamente con lo que quien pregunta ya puede ver, y cada consulta
            queda auditada.
          </span>
        </label>
      ...
      <p className="mt-3 text-xs text-muted">
        Última modificación del SLA:{' '}
        {fecha(actualizado.get('sla_primera_respuesta_minutos') ?? null)}
      </p>
    </AppShell>
  );
}
