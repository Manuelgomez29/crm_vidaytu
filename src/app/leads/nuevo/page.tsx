...
export default async function NuevoLead({
  ...
  return (
    <AppShell seccion="leads" titulo="Nuevo lead" descripcion="Alta manual de un caso">
      <p className="mt-1 text-sm text-ink2">
        Si el teléfono ya existe en el directorio, no se creará un duplicado: te llevaré a su caso
        (reabriéndolo si estaba cerrado).
      </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Campo etiqueta="Centro *">
            <select
              ...
              defaultValue={
                centrosPermitidos.find((c) => c.es_bandeja_grupo)?.id ?? centrosPermitidos[0]?.id
              }
            >
